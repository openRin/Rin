// Re-export t from types for schema definitions
export const t = {
    ...
    Record: (keyType: any, valueType: any) => ({ type: 'object', additionalProperties: true }),
    Any: () => ({ type: 'any' }),
};

// Type helper for extracting context types
